          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="flex items-center gap-2 px-2 py-1.5 text-xs font-semibold bg-blue-100 rounded-sm">
                  <IoDiamondOutline size={18} /> {postData.status}
                </span>
