...
const listings: IPendingProduct[] = data?.products || [];
...
return ( <div className="space-y-6"> <div> <h2 className="text-2xl font-semibold text-gray-800">Listings</h2> <p className="text-sm text-gray-500">Manage all product listings</p> </div>
